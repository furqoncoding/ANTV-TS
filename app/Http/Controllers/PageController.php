...
class PageController extends Controller
{
    public function index(Request $request) 
    {
        ...
        $ts_sponsor_deals = DB::select('SELECT ts_sponsor_deals.id,ts_sponsor_deals.employee_id,ts_sponsor_deals.employee_name,ts_sponsor_deals.employee_email,ts_sponsor_deals.start_periode,ts_sponsor_deals.end_periode,ts_sponsor_deals.budget_deals,,ts_sponsor_deals.ket_budget_deals,ts_sponsor_deals.net_deals_per_eps,ts_sponsor_deals.eps,ts_sponsor_deals.type_paket,ts_sponsor_deals.program,ts_sponsor_deals.status_deals,ts_sponsor.employee_id,ts_sponsor.employee_name,ts_sponsor.employee_email,ts_sponsor.no_paket,ts_sponsor.no_media_order,ts_sponsor.agency,ts_sponsor.advertiser_product,ts_sponsor.id FROM ts_sponsor_deals INNER JOIN ts_sponsor ON ts_sponsor.id=ts_sponsor_deals.id_sponsor ORDER BY ts_sponsor_deals.id DESC');
        $data = array(
